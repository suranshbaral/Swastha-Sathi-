                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                <h3 class="font-weight-bold">
                                            <a href="trainer-workout-event.php" style="text-decoration:none; color:black;"> Edit Event / <?=ucfirst($workout['class_name']); ?> - <?=ucfirst($workout['event_date']); ?> 
                                            ...
                                            <div class="col-12">
                                                <button type="submit" name="trainer_update_event" class="btn-sm btn btn-dark">
                                                    Update Event
                                                </button>
                                                <a type="submit" class="btn btn-sm btn-dark"  href="trainer-workout-event.php">Back</a>
