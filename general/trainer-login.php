                ...
                <div class="row g-0">
                  ...
                  <div class="col-md-6 col-lg-7 d-flex align-items-center">
                    <div class="card-body p-4 p-lg-5 text-black">
                      ...
                      <form action="trainer-login.php" method="post">
                      
                        <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Trainer Sign In
                        ...
                        <div class="pt-1 mb-4">
                            <button class="btn btn-dark btn-block" name="login_trainer" type="submit">Login</button>
                        </div>
                        <p class="mb-5 pb-lg-2" style="color: #030303;">Don't have a trainer account? <a href="trainer-register.php" style="color: #0f0f11;">Register here</a>
