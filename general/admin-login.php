              ...
              <div class="card" style="border-radius: 1rem; box-shadow: 0 0 15px 5px rgb(15, 6, 6)">
                <div class="row g-0">
                  <div class="col-md-6 col-lg-5 d-none d-md-block">
                    <img src="../images/admin-img.png" alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem;" />
                  </div>
                  <div class="col-md-6 col-lg-7 d-flex align-items-center">
                    <div class="card-body p-4 p-lg-5 text-black">
                      ...
                      <form action="admin-login.php" method="post">
                        ...
                        <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Swastha Sathi 
                        ...
                        <div class="pt-1 mb-4">
                            <button class="btn btn-dark btn-block" name="login_admin" type="submit">Login</button>
                        </div>
