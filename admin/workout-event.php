          ...
          <div class="content-wrapper">
                                      ...
                                      <div class="modal-dialog">
                                         <div class="modal-content">
                                           ...
                                           <div class="modal-footer">
                                             ...
                                             <button type="submit" name="delete_workout" value="<?=$workout['event_id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                           </div>
                                         </div>
                                       </div>
                                     </div>
            ...
            <div class="row">
              <div class="col-md-7 grid-margin stretch-card">
                  <div class="card-body">
                    <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#exampleModal"> + New Event </button>
                    <!-- Modal -->
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <form action="code.php" method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        <button type="submit" name="save_class" class="btn btn-dark">Add Class</button>
