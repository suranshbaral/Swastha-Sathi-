              ...
              <div class="col-md-12 grid-margin">
                <div class="row">
                  <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold">Customer Cart</h3>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      ...
                      //  $query = "SELECT * FROM order_cart";
                       ...
                       $query = "SELECT order_id, firstname, lastname, lastname, members.member_id, order_cart.product_id, pro_type, pickup_date, pro_desc, pro_Name  FROM order_cart INNER JOIN product ON product.product_id = order_cart.product_id INNER JOIN members ON order_cart.member_id = members.member_id WHERE order_id;";
                                       ...
                                       <div class="modal-dialog">
                                         <div class="modal-content">
                                           ...
                                           <div class="modal-body">
                                             <p>Deleting <?= ucfirst($membership['pro_Name']); ?> From <?= ucfirst($membership['firstname']); ?> items, are you sure?</p>
                                           </div>
                                           <div class="modal-footer">
                                             <button type="button" class="btn btn-dark btn-sm" data-bs-dismiss="modal">Close</button>
                                             <button type="submit" name="delete_product_order" value="<?=$membership['order_id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                           </div>
                                         </div>
                                       </div>
                                     </div>
