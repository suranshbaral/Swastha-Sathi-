...
<html lang="en">
  ...
  <body>
    <div class="container-scroller">
      <!-- partial:partials/_navbar.html --> <?php include ('../components/admin-navbar.php'); ?>
      <!-- partial -->
      <div class="container-fluid page-body-wrapper">
        <!-- partial:partials/_sidebar.html --> <?php include ('../components/admin-sidebar.php'); ?>
        <!-- partial -->
              ...
              <div class="col-md-12 grid-margin">
                  ...
                  <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <div class="card-body"> <?php
                            ...
                            ?> <h3 class="font-weight-bold">
                                            <a href="admin-member.php" style="text-decoration:none; color:black;"> View Member / <?=ucfirst($member['firstname']); ?> <?=ucfirst($member['lastname']); ?> </a>
                                                </h3>
                ...
                <div class="row">
                  <div class="col-md-2 stretch-card">
                    <div class="card-body">
                      <a type="button" class="btn btn-sm btn-dark" href="admin-member.php">Back</a>
